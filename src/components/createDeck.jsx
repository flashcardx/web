                                        ...
                                        <div className="col-sm-12">
                                            <div className="row">
                                                ...
                                                <div className="col-2 col-sm-2 col-md-1">
                                                    <Tooltip title="El lenguaje en el que vas a crear los titulos de las fichas adentro de este mazo, es importante ya que otros servicios como por ejemplo la &quot;pronunciacion automatica&quot; se basan en este campo.">
